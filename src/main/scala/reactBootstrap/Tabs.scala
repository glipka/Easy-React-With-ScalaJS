...
@js.native trait TabsProps extends Props[Tabs] with js.Any  {
  ...
  var paneWidth: Any = js.native // TODO: Add more specific type
  var position: String = js.native
  var tabWidth: Any = js.native // TODO: Add more specific type
