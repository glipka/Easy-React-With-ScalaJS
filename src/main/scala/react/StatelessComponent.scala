...
@js.native
abstract class StatelessComponent[P] extends js.Any {
  def apply(props: P, context: Any): ReactElement[_] = js.native
  var propTypes: ValidationMap[P] = js.native
  var contextTypes: ValidationMap[_] = js.native
  var defaultProps: P = js.native
  var displayName: String = js.native
  def apply(props: P): ReactElement[_] = js.native
  def apply(): ReactElement[_] = js.native
}
