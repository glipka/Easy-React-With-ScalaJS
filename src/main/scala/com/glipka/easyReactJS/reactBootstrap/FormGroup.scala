...
@js.native trait FormGroupProps extends HTMLProps[FormGroup] with js.Any {
...
@js.native
class FormGroup(props: FormGroupProps) extends Component[FormGroupProps, Any](props) with js.Any {}