...
@js.native
abstract class ClassicComponent[P, S](param: P) extends Component[P, S](param) with js.Any {
  def replaceState(nextState: S, callback: java.util.function.Supplier[Any]): Unit = js.native
