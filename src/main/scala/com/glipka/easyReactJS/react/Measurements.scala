...
// https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/react/react.d.ts
 ...
 @js.native
abstract class Measurements extends js.Any {
  ...
  var displayNames: DisplayNames =  js.native
  var totalTime: Double =js.native
  /** This is an automatically generated Any type (see the source definition). */
 
}
 @js.native
  class DisplayNames extends js.Any  {
    def $get(key: String): ComponentPerfContext = js.native
  }
