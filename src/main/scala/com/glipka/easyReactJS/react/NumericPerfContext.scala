...
// https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/react/react.d.ts
 @js.native
 abstract class NumericPerfContext extends js.Any   {
  
  // attention le type numeric Int est ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  revoir (equivalent type number java)
    def $get(key:String) : Numeric[Int] = js.native
}
